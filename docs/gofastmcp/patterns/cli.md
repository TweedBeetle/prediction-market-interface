...
scraped_at: 2025-11-03T18:42:20.331118
---

[Skip to main content](https://gofastmcp.com/patterns/cli#content-area)
...
*   [fastmcp run](https://gofastmcp.com/patterns/cli#fastmcp-run)
    
*   [Options](https://gofastmcp.com/patterns/cli#options)
    
*   [Entrypoints](https://gofastmcp.com/patterns/cli#entrypoints)
    
*   [Inferred Server Instance](https://gofastmcp.com/patterns/cli#inferred-server-instance)
    
*   [Explicit Server Entrypoint](https://gofastmcp.com/patterns/cli#explicit-server-entrypoint)
    
*   [Factory Function](https://gofastmcp.com/patterns/cli#factory-function)
    
*   [Remote Server Proxy](https://gofastmcp.com/patterns/cli#remote-server-proxy)
    
*   [FastMCP Configuration](https://gofastmcp.com/patterns/cli#fastmcp-configuration)
    
*   [MCP Configuration](https://gofastmcp.com/patterns/cli#mcp-configuration)
    
*   [fastmcp dev](https://gofastmcp.com/patterns/cli#fastmcp-dev)
    
*   [Options](https://gofastmcp.com/patterns/cli#options-2)
    
*   [Entrypoints](https://gofastmcp.com/patterns/cli#entrypoints-2)
    
*   [fastmcp install](https://gofastmcp.com/patterns/cli#fastmcp-install)
    
*   [Options](https://gofastmcp.com/patterns/cli#options-3)
    
*   [Entrypoints](https://gofastmcp.com/patterns/cli#entrypoints-3)
    
*   [MCP JSON Generation](https://gofastmcp.com/patterns/cli#mcp-json-generation)
    
*   [fastmcp inspect](https://gofastmcp.com/patterns/cli#fastmcp-inspect)
    
*   [Options](https://gofastmcp.com/patterns/cli#options-4)
    
*   [Output Formats](https://gofastmcp.com/patterns/cli#output-formats)
    
*   [FastMCP Format (--format fastmcp)](https://gofastmcp.com/patterns/cli#fastmcp-format-format-fastmcp)
    
*   [MCP Protocol Format (--format mcp)](https://gofastmcp.com/patterns/cli#mcp-protocol-format-format-mcp)
    
*   [Entrypoints](https://gofastmcp.com/patterns/cli#entrypoints-4)
    
*   [Examples](https://gofastmcp.com/patterns/cli#examples)
    
*   [fastmcp project prepare](https://gofastmcp.com/patterns/cli#fastmcp-project-prepare)
    
*   [Options](https://gofastmcp.com/patterns/cli#options-5)
    
*   [Usage Pattern](https://gofastmcp.com/patterns/cli#usage-pattern)
    
*   [fastmcp version](https://gofastmcp.com/patterns/cli#fastmcp-version)
    
*   [Options](https://gofastmcp.com/patterns/cli#options-6)
...
[​](https://gofastmcp.com/patterns/cli#commands-overview)
...
[​](https://gofastmcp.com/patterns/cli#fastmcp-run)
...
[​](https://gofastmcp.com/patterns/cli#options)
...
[​](https://gofastmcp.com/patterns/cli#entrypoints)

Entrypoints

`` New in version: `2.3.5` `` The `fastmcp run` command supports the following entrypoints:

1.  **[Inferred server instance](https://gofastmcp.com/patterns/cli#inferred-server-instance)
    **: `server.py` - imports the module and looks for a FastMCP server instance named `mcp`, `server`, or `app`. Errors if no such object is found.
2.  **[Explicit server entrypoint](https://gofastmcp.com/patterns/cli#explicit-server-entrypoint)
    **: `server.py:custom_name` - imports and uses the specified server entrypoint
3.  **[Factory function](https://gofastmcp.com/patterns/cli#factory-function)
    **: `server.py:create_server` - calls the specified function (sync or async) to create a server instance
4.  **[Remote server proxy](https://gofastmcp.com/patterns/cli#remote-server-proxy)
    **: `https://example.com/mcp-server` - connects to a remote server and creates a **local proxy server**
5.  **[FastMCP configuration file](https://gofastmcp.com/patterns/cli#fastmcp-configuration)
    **: `fastmcp.json` - runs servers using FastMCP’s declarative configuration format (auto-detects files in current directory)
...
[​](https://gofastmcp.com/patterns/cli#inferred-server-instance)
...
[​](https://gofastmcp.com/patterns/cli#explicit-server-entrypoint)
...
[​](https://gofastmcp.com/patterns/cli#factory-function)
...
[​](https://gofastmcp.com/patterns/cli#remote-server-proxy)
...
[​](https://gofastmcp.com/patterns/cli#fastmcp-configuration)
...
See [Server Configuration](https://gofastmcp.com/deployment/server-configuration)
 for detailed documentation on fastmcp.json.

#### 

[​](https://gofastmcp.com/patterns/cli#mcp-configuration)
...
[​](https://gofastmcp.com/patterns/cli#fastmcp-dev)

`fastmcp dev`
--------------------------------------------------------------------

Run a MCP server with the [MCP Inspector](https://github.com/modelcontextprotocol/inspector)
 for testing.
...
[​](https://gofastmcp.com/patterns/cli#options-2)
...
[​](https://gofastmcp.com/patterns/cli#entrypoints-2)
...
[​](https://gofastmcp.com/patterns/cli#fastmcp-install)
...
[​](https://gofastmcp.com/patterns/cli#options-3)
...
[​](https://gofastmcp.com/patterns/cli#entrypoints-3)
...
[​](https://gofastmcp.com/patterns/cli#mcp-json-generation)
...
[​](https://gofastmcp.com/patterns/cli#fastmcp-inspect)
...
[​](https://gofastmcp.com/patterns/cli#options-4)
...
[​](https://gofastmcp.com/patterns/cli#output-formats)

Output Formats

#### 

[​](https://gofastmcp.com/patterns/cli#fastmcp-format-format-fastmcp)
...
[​](https://gofastmcp.com/patterns/cli#mcp-protocol-format-format-mcp)
...
[​](https://gofastmcp.com/patterns/cli#entrypoints-4)
...
[​](https://gofastmcp.com/patterns/cli#examples)
...
[​](https://gofastmcp.com/patterns/cli#fastmcp-project-prepare)
...
[​](https://gofastmcp.com/patterns/cli#options-5)
...
[​](https://gofastmcp.com/patterns/cli#usage-pattern)
...
[​](https://gofastmcp.com/patterns/cli#fastmcp-version)
...
[​](https://gofastmcp.com/patterns/cli#options-6)
...
[Decorating Methods\
\
Previous](https://gofastmcp.com/patterns/decorating-methods)
[Contrib Modules\
\
Next](https://gofastmcp.com/patterns/contrib)
