---
url: https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-sources-filesystem
title: filesystem - FastMCP
scraped_at: 2025-11-03T18:43:11.469769
---
...
*   mcp\_server\_config
    ...
    *   [\_\_init\_\_](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-__init__)
        
    *   v1
        
        *   [\_\_init\_\_](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-__init__)
            
        *   environments
            
        *   [mcp\_server\_config](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config)
            
        *   sources
            
            *   [\_\_init\_\_](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-sources-__init__)
...
*   [fastmcp.utilities.mcp\_server\_config.v1.sources.filesystem](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-sources-filesystem#fastmcp-utilities-mcp-server-config-v1-sources-filesystem)
...
*   [parse\_path\_with\_object](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-sources-filesystem#parse-path-with-object)
    
*   [load\_server](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-sources-filesystem#load-server)
    

[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-sources-filesystem#fastmcp-utilities-mcp-server-config-v1-sources-filesystem)
...
`FileSystemSource`[](https://github.com/jlowin/fastmcp/blob/main/src/fastmcp/utilities/mcp_server_config/v1/sources/filesystem.py#L15)

Source for local Python files. **Methods:**

#### 

[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-sources-filesystem#parse-path-with-object)

`parse_path_with_object`[](https://github.com/jlowin/fastmcp/blob/main/src/fastmcp/utilities/mcp_server_config/v1/sources/filesystem.py#L28)
...
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-sources-filesystem#load-server)

`load_server`[](https://github.com/jlowin/fastmcp/blob/main/src/fastmcp/utilities/mcp_server_config/v1/sources/filesystem.py#L63)
...
[base\
\
Previous](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-sources-base)
[openapi\
\
Next](https://gofastmcp.com/python-sdk/fastmcp-utilities-openapi)
