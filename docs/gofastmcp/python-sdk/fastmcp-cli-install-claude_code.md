---
url: https://gofastmcp.com/python-sdk/fastmcp-cli-install-claude_code
title: claude_code - FastMCP
scraped_at: 2025-11-03T18:42:26.137253
---

[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-cli-install-claude_code#content-area)
...
*   install
    ...
    *   [\_\_init\_\_](https://gofastmcp.com/python-sdk/fastmcp-cli-install-__init__)
        
    *   [claude\_code](https://gofastmcp.com/python-sdk/fastmcp-cli-install-claude_code)
        
    *   [claude\_desktop](https://gofastmcp.com/python-sdk/fastmcp-cli-install-claude_desktop)
        
    *   [cursor](https://gofastmcp.com/python-sdk/fastmcp-cli-install-cursor)
        
    *   [gemini\_cli](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli)
        
    *   [mcp\_json](https://gofastmcp.com/python-sdk/fastmcp-cli-install-mcp_json)
...
*   [fastmcp.cli.install.claude\_code](https://gofastmcp.com/python-sdk/fastmcp-cli-install-claude_code#fastmcp-cli-install-claude-code)
    
*   [Functions](https://gofastmcp.com/python-sdk/fastmcp-cli-install-claude_code#functions)
    
*   [find\_claude\_command](https://gofastmcp.com/python-sdk/fastmcp-cli-install-claude_code#find-claude-command)
    
*   [check\_claude\_code\_available](https://gofastmcp.com/python-sdk/fastmcp-cli-install-claude_code#check-claude-code-available)
    
*   [install\_claude\_code](https://gofastmcp.com/python-sdk/fastmcp-cli-install-claude_code#install-claude-code)
    
*   [claude\_code\_command](https://gofastmcp.com/python-sdk/fastmcp-cli-install-claude_code#claude-code-command)
    

[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-claude_code#fastmcp-cli-install-claude-code)
...
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-claude_code#functions)
...
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-claude_code#find-claude-command)

`find_claude_command`[](https://github.com/jlowin/fastmcp/blob/main/src/fastmcp/cli/install/claude_code.py#L20)
...
Find the Claude Code CLI command. Checks common installation locations since ‘claude’ is often a shell alias that doesn’t work with subprocess calls.

### 

[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-claude_code#check-claude-code-available)

`check_claude_code_available`[](https://github.com/jlowin/fastmcp/blob/main/src/fastmcp/cli/install/claude_code.py#L68)
...
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-claude_code#install-claude-code)

`install_claude_code`[](https://github.com/jlowin/fastmcp/blob/main/src/fastmcp/cli/install/claude_code.py#L73)
...
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-claude_code#claude-code-command)

`claude_code_command`[](https://github.com/jlowin/fastmcp/blob/main/src/fastmcp/cli/install/claude_code.py#L153)
...
[\_\_init\_\_\
\
Previous](https://gofastmcp.com/python-sdk/fastmcp-cli-install-__init__)
[claude\_desktop\
\
Next](https://gofastmcp.com/python-sdk/fastmcp-cli-install-claude_desktop)
