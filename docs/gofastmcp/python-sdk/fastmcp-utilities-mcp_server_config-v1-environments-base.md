---
url: https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-base
title: base - FastMCP
scraped_at: 2025-11-03T18:43:04.400509
---
...
*   mcp\_server\_config
    ...
    *   v1
        ...
        *   environments
            ...
            *   [\_\_init\_\_](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-__init__)
...
*   [fastmcp.utilities.mcp\_server\_config.v1.environments.base](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-base#fastmcp-utilities-mcp-server-config-v1-environments-base)
...
*   [build\_command](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-base#build-command)
    
*   [prepare](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-base#prepare)
    

[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-base#fastmcp-utilities-mcp-server-config-v1-environments-base)
...
`Environment`[](https://github.com/jlowin/fastmcp/blob/main/src/fastmcp/utilities/mcp_server_config/v1/environments/base.py#L7)

Base class for environment configuration. **Methods:**

#### 

[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-base#build-command)

`build_command`[](https://github.com/jlowin/fastmcp/blob/main/src/fastmcp/utilities/mcp_server_config/v1/environments/base.py#L13)
...
`prepare`[](https://github.com/jlowin/fastmcp/blob/main/src/fastmcp/utilities/mcp_server_config/v1/environments/base.py#L24)
...
[\_\_init\_\_\
\
Previous](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-__init__)
[uv\
\
Next](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-uv)
