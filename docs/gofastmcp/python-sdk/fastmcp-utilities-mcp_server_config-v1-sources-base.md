---
url: https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-sources-base
title: base - FastMCP
scraped_at: 2025-11-03T18:43:11.518936
---
...
*   [fastmcp.utilities.mcp\_server\_config.v1.sources.base](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-sources-base#fastmcp-utilities-mcp-server-config-v1-sources-base)
...
*   [load\_server](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-sources-base#load-server)
    

[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-sources-base#fastmcp-utilities-mcp-server-config-v1-sources-base)
...
`Source`[](https://github.com/jlowin/fastmcp/blob/main/src/fastmcp/utilities/mcp_server_config/v1/sources/base.py#L7)
...
`prepare`[](https://github.com/jlowin/fastmcp/blob/main/src/fastmcp/utilities/mcp_server_config/v1/sources/base.py#L12)
...
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-sources-base#load-server)

`load_server`[](https://github.com/jlowin/fastmcp/blob/main/src/fastmcp/utilities/mcp_server_config/v1/sources/base.py#L23)
...
[\_\_init\_\_\
\
Previous](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-sources-__init__)
[filesystem\
\
Next](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-sources-filesystem)
