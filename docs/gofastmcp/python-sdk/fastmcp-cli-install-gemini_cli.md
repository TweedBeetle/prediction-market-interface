---
url: https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli
title: gemini_cli - FastMCP
scraped_at: 2025-11-03T18:42:26.612582
---
...
*   [fastmcp.cli.install.gemini\_cli](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli#fastmcp-cli-install-gemini-cli)
    
*   [Functions](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli#functions)
    
*   [find\_gemini\_command](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli#find-gemini-command)
    
*   [check\_gemini\_cli\_available](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli#check-gemini-cli-available)
    
*   [install\_gemini\_cli](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli#install-gemini-cli)
    
*   [gemini\_cli\_command](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli#gemini-cli-command)
    

[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli#fastmcp-cli-install-gemini-cli)
...
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli#find-gemini-command)

`find_gemini_command`[](https://github.com/jlowin/fastmcp/blob/main/src/fastmcp/cli/install/gemini_cli.py#L20)
...
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli#check-gemini-cli-available)

`check_gemini_cli_available`[](https://github.com/jlowin/fastmcp/blob/main/src/fastmcp/cli/install/gemini_cli.py#L64)
...
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli#install-gemini-cli)

`install_gemini_cli`[](https://github.com/jlowin/fastmcp/blob/main/src/fastmcp/cli/install/gemini_cli.py#L69)
...
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli#gemini-cli-command)

`gemini_cli_command`[](https://github.com/jlowin/fastmcp/blob/main/src/fastmcp/cli/install/gemini_cli.py#L150)
...
[cursor\
\
Previous](https://gofastmcp.com/python-sdk/fastmcp-cli-install-cursor)
[mcp\_json\
\
Next](https://gofastmcp.com/python-sdk/fastmcp-cli-install-mcp_json)
