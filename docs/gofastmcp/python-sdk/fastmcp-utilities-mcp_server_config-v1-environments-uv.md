---
url: https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-uv
title: uv - FastMCP
scraped_at: 2025-11-03T18:43:04.651401
---
...
*   [fastmcp.utilities.mcp\_server\_config.v1.environments.uv](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-uv#fastmcp-utilities-mcp-server-config-v1-environments-uv)
...
*   [build\_command](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-uv#build-command)
    
*   [prepare](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-uv#prepare)
    

[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-uv#fastmcp-utilities-mcp-server-config-v1-environments-uv)
...
`UVEnvironment`[](https://github.com/jlowin/fastmcp/blob/main/src/fastmcp/utilities/mcp_server_config/v1/environments/uv.py#L14)

Configuration for Python environment setup. **Methods:**

#### 

[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-uv#build-command)

`build_command`[](https://github.com/jlowin/fastmcp/blob/main/src/fastmcp/utilities/mcp_server_config/v1/environments/uv.py#L49)
...
`prepare`[](https://github.com/jlowin/fastmcp/blob/main/src/fastmcp/utilities/mcp_server_config/v1/environments/uv.py#L109)
...
[base\
\
Previous](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-base)
[mcp\_server\_config\
\
Next](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config)
