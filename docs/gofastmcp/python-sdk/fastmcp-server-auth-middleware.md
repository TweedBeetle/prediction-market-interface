---
url: https://gofastmcp.com/python-sdk/fastmcp-server-auth-middleware
title: middleware - FastMCP
scraped_at: 2025-11-03T18:42:40.791388
---

[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-auth-middleware#content-area)
...
*   [fastmcp.server.auth.middleware](https://gofastmcp.com/python-sdk/fastmcp-server-auth-middleware#fastmcp-server-auth-middleware)
    
*   [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-auth-middleware#classes)
    
*   [RequireAuthMiddleware](https://gofastmcp.com/python-sdk/fastmcp-server-auth-middleware#requireauthmiddleware)
    

[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-middleware#fastmcp-server-auth-middleware)
...
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-middleware#classes)
...
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-middleware#requireauthmiddleware)

`RequireAuthMiddleware`[](https://github.com/jlowin/fastmcp/blob/main/src/fastmcp/server/auth/middleware.py#L22)
...
[jwt\_issuer\
\
Previous](https://gofastmcp.com/python-sdk/fastmcp-server-auth-jwt_issuer)
[oauth\_proxy\
\
Next](https://gofastmcp.com/python-sdk/fastmcp-server-auth-oauth_proxy)
