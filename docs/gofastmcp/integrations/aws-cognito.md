...
title: AWS Cognito OAuth 🤝 FastMCP - FastMCP
...
`` New in version: `2.12.4` `` This guide shows you how to secure your FastMCP server using **AWS Cognito user pools**. Since AWS Cognito doesn’t support Dynamic Client Registration, this integration uses the [**OAuth Proxy**](https://gofastmcp.com/servers/auth/oauth-proxy)
 pattern to bridge AWS Cognito’s traditional OAuth with MCP’s authentication requirements. It also includes robust JWT token validation, ensuring enterprise-grade authentication.
...
[​](https://gofastmcp.com/integrations/aws-cognito#step-1%3A-create-an-aws-cognito-user-pool-and-app-client)
...
** and ensure you’re in your desired AWS region.Select **“User pools”** from the side navigation (click on the hamburger icon at the top left in case you don’t see any), and click **“Create user pool”** to create a new user pool.
...
[​](https://gofastmcp.com/integrations/aws-cognito#environment-variables)
...
[​](https://gofastmcp.com/integrations/aws-cognito#provider-selection)
...
[​](https://gofastmcp.com/integrations/aws-cognito#param-fastmcp-server-auth)
...
[​](https://gofastmcp.com/integrations/aws-cognito#aws-cognito-specific-configuration)
...
[​](https://gofastmcp.com/integrations/aws-cognito#param-fastmcp-server-auth-aws-cognito-user-pool-id)
...
[​](https://gofastmcp.com/integrations/aws-cognito#param-fastmcp-server-auth-aws-cognito-aws-region)
...
[​](https://gofastmcp.com/integrations/aws-cognito#param-fastmcp-server-auth-aws-cognito-client-id)
...
[​](https://gofastmcp.com/integrations/aws-cognito#param-fastmcp-server-auth-aws-cognito-client-secret)
...
[​](https://gofastmcp.com/integrations/aws-cognito#param-fastmcp-server-auth-aws-cognito-base-url)
...
[​](https://gofastmcp.com/integrations/aws-cognito#param-fastmcp-server-auth-aws-cognito-issuer-url)
...
[​](https://gofastmcp.com/integrations/aws-cognito#param-fastmcp-server-auth-aws-cognito-redirect-path)
...
[​](https://gofastmcp.com/integrations/aws-cognito#param-fastmcp-server-auth-aws-cognito-required-scopes)
