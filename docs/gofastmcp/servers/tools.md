...
scraped_at: 2025-11-03T18:43:22.579694
---
...
*   [Excluding Arguments](https://gofastmcp.com/servers/tools#excluding-arguments)
...
*   [Disabling Tools](https://gofastmcp.com/servers/tools#disabling-tools)
...
[​](https://gofastmcp.com/servers/tools#the-%40tool-decorator)
...
A boolean to enable or disable the tool. See [Disabling Tools](https://gofastmcp.com/servers/tools#disabling-tools)
...
`` New in version: `2.14.0` ``Optional list of icon representations for this tool. See [Icons](https://gofastmcp.com/servers/icons)
 for detailed examples

[​](https://gofastmcp.com/servers/tools#param-exclude-args)

exclude\_args

list\[str\] | None

A list of argument names to exclude from the tool schema shown to the LLM. See [Excluding Arguments](https://gofastmcp.com/servers/tools#excluding-arguments)
 for more information
...
`` New in version: `2.10.0` `` The 6/18/2025 MCP spec update [introduced](https://modelcontextprotocol.io/specification/2025-06-18/server/tools#output-schema)
 output schemas, which are a new way to describe the expected output format of a tool. When an output schema is provided, the tool _must_ return structured output that matches the schema. When you add return type annotations to your functions, FastMCP automatically generates JSON schemas that describe the expected output format. These schemas help MCP clients understand and validate the structured data they receive.
...
Notifications are only sent when these operations occur within an active MCP request context (e.g., when called from within a tool or other MCP operation). Operations performed during server initialization do not trigger notifications. Clients can handle these notifications using a [message handler](https://gofastmcp.com/clients/messages)
 to automatically refresh their tool lists or update their interfaces.
...
[The FastMCP Server\
\
Previous](https://gofastmcp.com/servers/server)
[Resources & Templates\
\
Next](https://gofastmcp.com/servers/resources)
