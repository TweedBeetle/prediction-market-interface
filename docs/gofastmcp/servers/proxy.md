...
title: Proxy Servers - FastMCP
description: Use FastMCP to act as an intermediary or change transport for other MCP servers.
scraped_at: 2025-11-03T18:43:18.608268
---

[Skip to main content](https://gofastmcp.com/servers/proxy#content-area)
...
*   [Key Benefits](https://gofastmcp.com/servers/proxy#key-benefits)
    
*   [Performance Considerations](https://gofastmcp.com/servers/proxy#performance-considerations)
    
*   [Quick Start](https://gofastmcp.com/servers/proxy#quick-start)
    
*   [Session Isolation & Concurrency](https://gofastmcp.com/servers/proxy#session-isolation-%26-concurrency)
    
*   [Fresh Sessions](https://gofastmcp.com/servers/proxy#fresh-sessions)
    
*   [Session Reuse with Connected Clients](https://gofastmcp.com/servers/proxy#session-reuse-with-connected-clients)
    
*   [Transport Bridging](https://gofastmcp.com/servers/proxy#transport-bridging)
    
*   [Advanced MCP Features](https://gofastmcp.com/servers/proxy#advanced-mcp-features)
    
*   [Supported Features](https://gofastmcp.com/servers/proxy#supported-features)
    
*   [Customizing Feature Support](https://gofastmcp.com/servers/proxy#customizing-feature-support)
    
*   [Configuration-Based Proxies](https://gofastmcp.com/servers/proxy#configuration-based-proxies)
    
*   [Multi-Server Configurations](https://gofastmcp.com/servers/proxy#multi-server-configurations)
    
*   [Component Prefixing](https://gofastmcp.com/servers/proxy#component-prefixing)
    
*   [Mirrored Components](https://gofastmcp.com/servers/proxy#mirrored-components)
    
*   [FastMCPProxy Class](https://gofastmcp.com/servers/proxy#fastmcpproxy-class)
    
*   [Direct Usage](https://gofastmcp.com/servers/proxy#direct-usage)
    
*   [Parameters](https://gofastmcp.com/servers/proxy#parameters)
    
*   [Explicit Session Management](https://gofastmcp.com/servers/proxy#explicit-session-management)
...
[​](https://gofastmcp.com/servers/proxy#what-is-proxying%3F)
...
[​](https://gofastmcp.com/servers/proxy#key-benefits)
...
[​](https://gofastmcp.com/servers/proxy#performance-considerations)
...
When using proxy servers, especially those connecting to HTTP-based backend servers, be aware that latency can be significant. Operations like `list_tools()` may take hundreds of milliseconds compared to 1-2ms for local tools. When mounting proxy servers, this latency affects all operations on the parent server, not just interactions with the proxied tools. If low latency is a requirement for your use-case, consider using [`import_server()`](https://gofastmcp.com/servers/composition#importing-static-composition)
 to copy tools at startup rather than proxying them at runtime.

[​](https://gofastmcp.com/servers/proxy#quick-start)
...
[​](https://gofastmcp.com/servers/proxy#fresh-sessions)
...
[​](https://gofastmcp.com/servers/proxy#session-reuse-with-connected-clients)
...
[​](https://gofastmcp.com/servers/proxy#advanced-mcp-features)
...
[​](https://gofastmcp.com/servers/proxy#supported-features)
...
[​](https://gofastmcp.com/servers/proxy#customizing-feature-support)
...
[​](https://gofastmcp.com/servers/proxy#configuration-based-proxies)
...
[​](https://gofastmcp.com/servers/proxy#multi-server-configurations)
...
[​](https://gofastmcp.com/servers/proxy#component-prefixing)
...
[​](https://gofastmcp.com/servers/proxy#mirrored-components)
...
[​](https://gofastmcp.com/servers/proxy#fastmcpproxy-class)
...
[​](https://gofastmcp.com/servers/proxy#direct-usage)
...
[​](https://gofastmcp.com/servers/proxy#parameters)
...
[​](https://gofastmcp.com/servers/proxy#explicit-session-management)
...
[Progress Reporting\
\
Previous](https://gofastmcp.com/servers/progress)
[LLM Sampling\
\
Next](https://gofastmcp.com/servers/sampling)
