...
scraped_at: 2025-11-03T18:43:18.059069
---
...
[​](https://gofastmcp.com/servers/elicitation#what-is-elicitation%3F)
...
[​](https://gofastmcp.com/servers/elicitation#basic-usage)
...
[​](https://gofastmcp.com/servers/elicitation#method-signature)
...
The Python type defining the expected response structure (dataclass, primitive type, etc.) Note that elicitation responses are subject to a restricted subset of JSON Schema types. See [Supported Response Types](https://gofastmcp.com/servers/elicitation#supported-response-types)
 for more details.
...
[​](https://gofastmcp.com/servers/elicitation#elicitation-actions)
...
[​](https://gofastmcp.com/servers/elicitation#response-types)
...
Elicitation requires the client to implement an elicitation handler. See [Client Elicitation](https://gofastmcp.com/clients/elicitation)
 for details on how clients can handle these requests. If a client doesn’t support elicitation, calls to `ctx.elicit()` will raise an error indicating that elicitation is not supported.

[MCP Context\
\
Previous](https://gofastmcp.com/servers/context)
[Icons\
\
Next](https://gofastmcp.com/servers/icons)
