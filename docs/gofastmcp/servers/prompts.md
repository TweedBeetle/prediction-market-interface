...
scraped_at: 2025-11-03T18:43:18.075561
---
...
[​](https://gofastmcp.com/servers/prompts#what-are-prompts%3F)
...
[​](https://gofastmcp.com/servers/prompts#the-%40prompt-decorator)
...
A boolean to enable or disable the prompt. See [Disabling Prompts](https://gofastmcp.com/servers/prompts#disabling-prompts)
...
`` New in version: `2.14.0` ``Optional list of icon representations for this prompt. See [Icons](https://gofastmcp.com/servers/icons)
...
Notifications are only sent when these operations occur within an active MCP request context (e.g., when called from within a tool or other MCP operation). Operations performed during server initialization do not trigger notifications. Clients can handle these notifications using a [message handler](https://gofastmcp.com/clients/messages)
 to automatically refresh their prompt lists or update their interfaces.
...
[Resources & Templates\
\
Previous](https://gofastmcp.com/servers/resources)
[Server Composition\
\
Next](https://gofastmcp.com/servers/composition)
