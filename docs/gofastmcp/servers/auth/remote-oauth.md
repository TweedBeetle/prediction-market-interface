...
scraped_at: 2025-11-03T18:43:12.304821
---
...
If your provider doesn’t support DCR (most traditional OAuth providers), you’ll need to use [`OAuth Proxy`](https://gofastmcp.com/servers/auth/oauth-proxy)
...
`RemoteAuthProvider` works by composing a [`TokenVerifier`](https://gofastmcp.com/servers/auth/token-verification)
...
[Token Verification\
\
Previous](https://gofastmcp.com/servers/auth/token-verification)
[OAuth Proxy\
\
Next](https://gofastmcp.com/servers/auth/oauth-proxy)
