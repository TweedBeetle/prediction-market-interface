...
scraped_at: 2025-11-03T18:43:17.527156
---
...
*   [Via Runtime Dependency Function](https://gofastmcp.com/servers/context#via-runtime-dependency-function)
...
*   [State Management](https://gofastmcp.com/servers/context#state-management)
...
*   [Runtime Dependencies](https://gofastmcp.com/servers/context#runtime-dependencies)
    
*   [HTTP Requests](https://gofastmcp.com/servers/context#http-requests)
    
*   [HTTP Headers](https://gofastmcp.com/servers/context#http-headers)
    
*   [Access Tokens](https://gofastmcp.com/servers/context#access-tokens)
    
*   [Working with Token Claims](https://gofastmcp.com/servers/context#working-with-token-claims)
    

When defining FastMCP [tools](https://gofastmcp.com/servers/tools)
, [resources](https://gofastmcp.com/servers/resources)
, resource templates, or [prompts](https://gofastmcp.com/servers/prompts)
, your functions might need to interact with the underlying MCP session or access advanced server capabilities. FastMCP provides the `Context` object for this purpose.

[​](https://gofastmcp.com/servers/context#what-is-context%3F)
...
[​](https://gofastmcp.com/servers/context#via-dependency-injection)
...
[​](https://gofastmcp.com/servers/context#tools)
...
[​](https://gofastmcp.com/servers/context#resources-and-templates)
...
[​](https://gofastmcp.com/servers/context#prompts)
...
[​](https://gofastmcp.com/servers/context#via-runtime-dependency-function)
...
See [Server Logging](https://gofastmcp.com/servers/logging)
...
See [User Elicitation](https://gofastmcp.com/servers/elicitation)
 for detailed examples and supported response types.
...
See [LLM Sampling](https://gofastmcp.com/servers/sampling)
 for comprehensive usage and advanced techniques.
...
See [Progress Reporting](https://gofastmcp.com/servers/progress)
...
[​](https://gofastmcp.com/servers/context#state-management)
...
[​](https://gofastmcp.com/servers/context#runtime-dependencies)
...
[​](https://gofastmcp.com/servers/context#access-tokens)
...
[​](https://gofastmcp.com/servers/context#working-with-token-claims)
...
[Server Composition\
\
Previous](https://gofastmcp.com/servers/composition)
[User Elicitation\
\
Next](https://gofastmcp.com/servers/elicitation)
